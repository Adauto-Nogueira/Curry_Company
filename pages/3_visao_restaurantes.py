        ...
        Parâmetros:
            Input: 
                ...
                - op: Tipo de operação que precisa ser calculado
                    'avg_time': (std) Calcula o tempo médio
                    'std_time': (std) Calcula o desvio padrão do tempo.
                    'festival': (std) Indica se o período de entrega foi realizado durante um Festival
            Output:
